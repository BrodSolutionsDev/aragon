            ...
            <div className="col-xl-3 col-lg-4 col-md-12 col-sm-12 col-12 dr-ltr">
              <div className="sidebar">
                <div className="widget-title">
                  <h3 className="text-heading-5 color-gray-900">
                    Filter items
                  </h3>
                </div>
                <div className="widget-content">
                  <div className="mt-30">
                    <span className="color-gray-500 d-inline-block mr-5">
                      Price Range:
                    </span>
                    <span className="text-heading-5 color-green-900 d-inline-block">
                      <span id="price-from">$16</span> -{" "}
                      <span id="price-to">$173</span>
                    </span>
                    <input
                  ...
                  <h4 className="text-heading-6 color-green-900 mt-30">
                    Used for
                  </h4>
                      ...
                      <div className="product-item-2 product-item-4">
                        <div className="product-image">
                          <Link href="#">
                            <a>
                              <img
                                src="/assets/imgs/page/shop1/sp5.png"
                                alt="agon"
                              />
                            </a>
                          </Link>
                      ...
                      <div className="product-item-2 product-item-4">
                        <div className="product-image">
                          <Link href="#">
                            <a>
                              <img
                                src="/assets/imgs/page/shop1/sp4.png"
                                alt="agon"
                              />
                            </a>
                          </Link>
